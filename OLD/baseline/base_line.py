...
def baseline_print(choice):
    ...
    if choice == 2:
        n = int(input("Enter diagonal length: "))
        lim = int(input("Enter max cluster size: "))
        perc = baseline_diamond(n,lim)
        print("% filling = ",perc)
        for r in range(n):
            for c in range(n):
               print(set[r][c],end = '   ')
        ...
        ch = input("Press enter to continue ")
    if choice == 3:
        size = int(input("Enter square dimension: "))
        h_length = int(input("Enter hole length: "))
        h_breadth = int(input("Enter hole breadth: "))
        lim = int(input("Enter max cluster size: "))       
        perc = baseline_hole(size,h_length,h_breadth,lim)
        print("% filling = ",perc)
        for r in range(size):
            for c in range(size):
               print(seats[r][c],end = '   ')
